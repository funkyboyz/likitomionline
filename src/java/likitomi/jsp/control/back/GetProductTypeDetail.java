 ...
 */
public class GetProductTypeDetail extends HttpServlet 
{
...
//            Call Model
            ...
            ProductType productType = productTypeTable.findById(id);
            db.close();
            
//            Go to View
            request.setAttribute("productType", productType);
            
            RequestDispatcher rd = request.getRequestDispatcher("edit_product_type.jsp");
